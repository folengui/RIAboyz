...
def run_neat():
    ...
    # Guardar solo lo esencial (con sufijo _3)
    print(f"\n💾 Guardando resultados...")
    with open(f"{RESULTS_DIR}/best_genome_3.pkl", 'wb') as f:
    ...
    print(f"  ✓ Genoma y estadísticas guardados en: {RESULTS_DIR}/")
    ...
    try:
        ...
        print(f"  ✓ Todas las gráficas generadas correctamente")
    except Exception as e:
