...
class NEATTrainerFast:
    ...
    def eval_genome(self, genome, config):
        ...
        try:
            ...
            while not done and steps < max_steps:
                ...
                steps += 1
                if (steps % 50 == 0 and self.env.saw_cylinder == False) or self.env.steps_since_saw_cylinder == 20:
                    break
    ...
    def run_evolution(self, config_file, n_generations=15):
        ...
        self.save_results(winner, stats, config_file)
    ...
    def save_results(self, winner, stats, config):
        ...
        # Guardar mejor genoma
        winner_path = os.path.join(self.models_dir, 'best_genome2.pkl')
...
def main():
    ...
    N_GENERATIONS = 20      # Reducido de 50
    MAX_STEPS = 100          # Reducido de 100
    ROBOBO_IP = 'localhost'
