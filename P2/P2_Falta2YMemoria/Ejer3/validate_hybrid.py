...
# NEAT (Fase 1)
NEAT_GENOME_PATH = "models/best_genome_3.pkl"
NEAT_CONFIG_PATH = "config-neat-obstacle-3-fast"
NEAT_MAX_STEPS = 50  # Máximo de pasos para fase NEAT

# PPO (Fase 2)
PPO_MODEL_PATH = "models/ppo_robobo_final2.zip"
PPO_MAX_STEPS = 150  # Máximo de pasos para fase PPO

# Validación
VALIDATION_DIR = "results/validation_hybrid"
N_TEST_EPISODES = 1
